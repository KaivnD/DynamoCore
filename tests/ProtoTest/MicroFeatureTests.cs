...
namespace ProtoTest
{
    public class MicroFeatureTests : ProtoTestBase
    {
        ...
        public void SimulateCBNExecution()
        {
            ...
            added.Add(TestFrameWork.CreateSubTreeFromCode(guid, code));
        ...
        public void SimulateConnectedCBNExecution()
        {
            ...
            List<Subtree> added = new List<Subtree>();
            added.Add(TestFrameWork.CreateSubTreeFromCode(cbnGuid1, codes[0]));
            added.Add(TestFrameWork.CreateSubTreeFromCode(cbnGuid2, codes[1]));
            var syncData = new GraphSyncData(null, added, null);
        ...
        public void SimulateConnectedCBNReExecution()
        {
            ...
            Subtree subtree = TestFrameWork.CreateSubTreeFromCode(cbnGuid1, codes[2]);
        ...
        public void TestAdd01()
        {
            ...
            for (int i = 0; i < shuffleCount; ++i)
            {
                ...
                var added = index.Select(idx => TestFrameWork.CreateSubTreeFromCode(guids[idx], codes[idx])).ToList();
        ...
        public void TestModify01()
        {
            ...
            for (int i = 0; i < 10; ++i)
            {
                ...
                var modified = index.Select(idx => TestFrameWork.CreateSubTreeFromCode(guids[idx], codes[idx])).ToList();
...
"
        ...
        public void RegressMAGN747()
        {
            ...
            // add two nodes
            IEnumerable<int> index = Enumerable.Range(0, codes.Count);
            var added = index.Select(idx => TestFrameWork.CreateSubTreeFromCode(guid, codes[idx])).ToList();
            ...
            var modified = index.Select(idx => TestFrameWork.CreateSubTreeFromCode(guid, codes[idx])).ToList();
...
",
 ...
 @" p = f();"
            ...
            added.Add(TestFrameWork.CreateSubTreeFromCode(guid2, codes[2]));
            ...
            // Modify function def - removed imperative block
            List<Subtree> modified = new List<Subtree>();
            modified.Add(TestFrameWork.CreateSubTreeFromCode(guid1, codes[1]));
        ...
        public void TestFunctionModification01()
        {
...

            {
                // Modify the function and verify
                List<Subtree> modified = new List<Subtree>();
                modified.Add(TestFrameWork.CreateSubTreeFromCode(guid, codes[2]));
        ...
        public void TestFunctionModification02()
        {
            ...
            for (int i = 0; i < shuffleCount; ++i)
            {
                ...
                {
                    List<Subtree> modified = new List<Subtree>();
                    modified.Add(TestFrameWork.CreateSubTreeFromCode(guid, codes[index]));
...
",
        ...
        public void TestFunctionRedefinitionOnNewNode01()
        {
            ...
            guid = System.Guid.NewGuid();
            {
                ...
                added.Add(TestFrameWork.CreateSubTreeFromCode(guid, codes[1]));
        ...
        public void TestFunctionRedefinitionOnExistingNode01()
        {
            ...
            added.Add(TestFrameWork.CreateSubTreeFromCode(guid_func, codes[0]));
            ...
            modified.Add(TestFrameWork.CreateSubTreeFromCode(guid_func, codes[2]));
        ...
        public void TestFunctionRedefinitionOnUnmodifiedNode02()
        {
            ...
            guid = System.Guid.NewGuid();
            added.Add(TestFrameWork.CreateSubTreeFromCode(guid, codes[2]));
            ...
            modified.Add(TestFrameWork.CreateSubTreeFromCode(guid_func, codes[3]));
        ...
        public void TestFunctionOverloadRedefinitionOnUnmodifiedNode01()
        {
            ...
            added.Add(TestFrameWork.CreateSubTreeFromCode(guid_func1, codes[0]));


            // A CBN with function overload def f(i)
            Guid guid_func2 = System.Guid.NewGuid();
            added.Add(TestFrameWork.CreateSubTreeFromCode(guid_func2, codes[1]));
            ...
            guid = System.Guid.NewGuid();
            added.Add(TestFrameWork.CreateSubTreeFromCode(guid, codes[3]));
            ...
            modified.Add(TestFrameWork.CreateSubTreeFromCode(guid_func2, codes[4]));
        ...
        public void TestFunctionOverloadRedefinitionOnUnmodifiedNode02()
        {
            ...
            modified.Add(TestFrameWork.CreateSubTreeFromCode(guid_func1, codes[4]));
            modified.Add(TestFrameWork.CreateSubTreeFromCode(guid_func2, codes[5]));
 ...
 ";
        ...
        public void TestCodeblockModification02()
        {
            ...
            deleted.Add(TestFrameWork.CreateSubTreeFromCode(guid2, codes[1]));
            syncData = new GraphSyncData(deleted, null, null);
            liveRunner.UpdateGraph(syncData);

            // Connect a and c to d = a + c
            List<Subtree> modified = new List<Subtree>();
            modified.Add(TestFrameWork.CreateSubTreeFromCode(guid4, codes[4]));
        ...
        public void TestCodeblockModification03()
        {
            ...
            // Connect b to c 
            List<Subtree> modified = new List<Subtree>();
            modified.Add(TestFrameWork.CreateSubTreeFromCode(guid3, codes[3]));
            ...
            // Delete first node
            List<Subtree> deleted = new List<Subtree>();
            deleted.Add(TestFrameWork.CreateSubTreeFromCode(guid1, codes[0]));
            syncData = new GraphSyncData(deleted, null, null);
            liveRunner.UpdateGraph(syncData);
            ...
            // Add new node d = c + 10;
            added = new List<Subtree>();
            added.Add(TestFrameWork.CreateSubTreeFromCode(guid4, codes[4]));
            syncData = new GraphSyncData(null, added, null);
            liveRunner.UpdateGraph(syncData);
        ...
        public void TestCodeblockModification04()
        {
            ...
            // Reconnect g2 
            List<Subtree> modified = new List<Subtree>();
            modified.Add(TestFrameWork.CreateSubTreeFromCode(guid2, codes[3]));
        ...
        public void TestPersistentValuesOnUpdate()
        {
            ...
            added.Add(TestFrameWork.CreateSubTreeFromCode(guid, codes[0]));
            Guid guid1 = System.Guid.NewGuid();
            added.Add(TestFrameWork.CreateSubTreeFromCode(guid1, codes[1]));
            Guid guid2 = System.Guid.NewGuid();
            added.Add(TestFrameWork.CreateSubTreeFromCode(guid2, codes[2]));
        ...
        public void TestCodeblockModification10()
        {
            ...
            modified = new List<Subtree>();
            modified.Add(TestFrameWork.CreateSubTreeFromCode(guid, codes[3]));
            syncData = new GraphSyncData(null, null, modified);
            liveRunner.UpdateGraph(syncData);
            AssertValue("b", 5.0);
        }
        ...
        public void TestCodeblockModification13()
        {
            ...
            added = new List<Subtree>();
            added.Add(TestFrameWork.CreateSubTreeFromCode(guid2, codes[1]));
            added.Add(TestFrameWork.CreateSubTreeFromCode(guid3, codes[3]));
            syncData = new GraphSyncData(null, added, null);
            liveRunner.UpdateGraph(syncData);

            // Connect Point to 'a'
            List<Subtree> modified = new List<Subtree>();
            modified.Add(TestFrameWork.CreateSubTreeFromCode(guid3, codes[4]));
            syncData = new GraphSyncData(null, null, modified);
            liveRunner.UpdateGraph(syncData);

            // Modify x
            modified = new List<Subtree>();
            modified.Add(TestFrameWork.CreateSubTreeFromCode(guid2, codes[2]));
            syncData = new GraphSyncData(null, null, modified);
            liveRunner.UpdateGraph(syncData);
        ...
        public void TestCodeblockModification16()
        {
            ...
            added = new List<Subtree>();
            added.Add(TestFrameWork.CreateSubTreeFromCode(guid4, codes[1]));
            syncData = new GraphSyncData(null, added, null);
            liveRunner.UpdateGraph(syncData);
            AssertValue("y", 10.0);
            ...
            List<Subtree> modified = new List<Subtree>();
            modified.Add(TestFrameWork.CreateSubTreeFromCode(guid2, codes[4]));
            syncData = new GraphSyncData(null, null, modified);
            liveRunner.UpdateGraph(syncData);
            AssertValue("i", 10.0);
            ...
            // Delete CBN
            List<Subtree> deleted = new List<Subtree>();
            deleted.Add(TestFrameWork.CreateSubTreeFromCode(guid4, codes[1]));
            syncData = new GraphSyncData(deleted, null, null);
            liveRunner.UpdateGraph(syncData);
            AssertValue("i", 0.0);
        }
        ...
        public void TestEmptyCodeblock01()
        {
            ...
            List<Subtree> added = new List<Subtree>();
            Guid guid = System.Guid.NewGuid();
            added.Add(TestFrameWork.CreateSubTreeFromCode(guid, ""));
            var syncData = new GraphSyncData(null, added, null);
            liveRunner.UpdateGraph(syncData);
            ...
            List<Subtree> modified = new List<Subtree>();
            modified = new List<Subtree>();
            modified.Add(TestFrameWork.CreateSubTreeFromCode(guid, codes[0]));
            syncData = new GraphSyncData(null, null, modified);
            liveRunner.UpdateGraph(syncData);
            AssertValue("a", 1);
        ...
        public void TestDeleteNode03()
        {
            ...
            // Delete the node
            List<Subtree> deleted = new List<Subtree>();
            deleted.Add(TestFrameWork.CreateSubTreeFromCode(guid, codes[0]));
            syncData = new GraphSyncData(deleted, null, null);
            liveRunner.UpdateGraph(syncData);
        ...
        public void TestCachingSSA02()
        {
            ...
            List<Subtree> modified = new List<Subtree>();
            modified.Add(TestFrameWork.CreateSubTreeFromCode(guid5, codes[4]));
        ...
        public void RegressMAGN747_02()
        {
            ...
            modified = new List<Subtree>();
            {
                modified.Add(TestFrameWork.CreateSubTreeFromCode(guid2, codes[1]));
...
//        }
        ...
        public void TestReExecute01()
        {
            ...
            List<Subtree> modified = new List<Subtree>();
            Subtree subtree = TestFrameWork.CreateSubTreeFromCode(guid2, codes[1]);
        ...
        public void TestReExecute02()
        {
            ...
            // Modify
            List<Subtree> modified = new List<Subtree>();
            Subtree subtree = TestFrameWork.CreateSubTreeFromCode(guid, codes[1]);
            modified.Add(subtree);
            syncData = new GraphSyncData(null, null, modified);
            liveRunner.UpdateGraph(syncData);
            AssertValue("a", 2);
        ...
        public void TestReExecuteOnModifiedNode01()
        {
            ...
            List<Subtree> modified = new List<Subtree>();
            Subtree subtree = TestFrameWork.CreateSubTreeFromCode(guid2, codes[3]);
            subtree.ForceExecution = true;
            modified.Add(subtree);
            syncData = new GraphSyncData(null, null, modified);
            liveRunner.UpdateGraph(syncData);
        ...
        public void ReproMAGN3551()
        {
            ...
            Subtree cbn2 = TestFrameWork.CreateSubTreeFromCode(guid2, codes[1]);
            added.Add(cbn2);
            ...
            Guid guid4 = System.Guid.NewGuid();
            Subtree cbn4 = TestFrameWork.CreateSubTreeFromCode(guid4, codes[3]);
            added.Add(cbn4);
        ...
        public void ReproMAGN3576()
        {
            ...
            // Create CBN3 to create b = 
            Guid guid3 = System.Guid.NewGuid();
            Subtree cbn3 = TestFrameWork.CreateSubTreeFromCode(guid3, codes[2]);
            added.Add(cbn3);
            ...
            Subtree newCBN4 = TestFrameWork.CreateSubTreeFromCode(guid4, "a_6 = null; b_6 = t_0_a; t_0_7 = DummyLine.ByStartPointEndPoint(a_6,b_6);");
        ...
        public void ReproMAGN3576Ext()
        {
            ...
            //Delete CBN3
            //Modify CBN4 to set in arg from CBN 3 to be null
            Subtree newCBN4 = TestFrameWork.CreateSubTreeFromCode(guid4, "a_6 = null; b_6 = t_0_a; t_0_6 = DummyLine.ByStartPointEndPoint(a_6,b_6);");
            syncData = new GraphSyncData(new List<Subtree>() { cbn3 }, null, new List<Subtree> { newCBN4 });
        ...
        public void ReproMAGN3551Ext()
        {
            ...
            //Delete b_in = ...
            Subtree cbn4New = TestFrameWork.CreateSubTreeFromCode(guid4,
        ...
        public void ReproMAGNXXX()
        {
            ...
            added.Add(TestFrameWork.CreateSubTreeFromCode(guid0, codes[0]));
            var syncData = new GraphSyncData(null, added, null);
            ...
            Subtree cbnNum = TestFrameWork.CreateSubTreeFromCode(guid1, codes[1]);
            added.Add(cbnNum);

            // Create CBN2 to create v0 = 
            Guid guid2 = System.Guid.NewGuid();
            Subtree cbnPt = TestFrameWork.CreateSubTreeFromCode(guid2, codes[2]);
            Subtree cbnDel = TestFrameWork.CreateSubTreeFromCode(guid2,
...
"
            ...
            List<Subtree> modified = new List<Subtree>();
            Subtree subtree = TestFrameWork.CreateSubTreeFromCode(guid1, codes[1]);
            modified.Add(subtree);
            syncData = new GraphSyncData(null, null, modified);
            liveRunner.UpdateGraph(syncData);
            AssertValue("r", 2);
...
";
            ...
            Guid guid1 = System.Guid.NewGuid();
            List<Subtree> added = new List<Subtree>();
            added.Add(TestFrameWork.CreateSubTreeFromCode(guid1, code));
            var syncData = new GraphSyncData(null, added, null);
            liveRunner.UpdateGraph(syncData);
            AssertValue("r", 1024);
        }
...
";
        ...
        public void TestTransactionUpdate03()
        {
            ...
            // Modify CBN2 with same contents with ForceExecution flag set
            Subtree subtree = TestFrameWork.CreateSubTreeFromCode(guid2, codes[4]);
            List<Subtree> modified = new List<Subtree>();
            modified.Add(subtree);
            syncData = new GraphSyncData(null, null, modified);
            liveRunner.UpdateGraph(syncData);
        ...
        public void TestTransactionUpdate04()
        {
            ...
            subtree = TestFrameWork.CreateSubTreeFromCode(guid3, codes[2]);
            subtree.ForceExecution = true;
            modified.Add(subtree);
        ...
        public void RegressMAGN5353()
        {
            ...
            added.Add(TestFrameWork.CreateSubTreeFromCode(guid1, code1));

            var guid2 = Guid.NewGuid();
            var code2 = "y = DisposeTracer.DisposeCount;";
            added.Add(TestFrameWork.CreateSubTreeFromCode(guid2, code2));
            ...
            syncData = new GraphSyncData(deleted, new List<Subtree> { TestFrameWork.CreateSubTreeFromCode(guid3, code3) }, null);
            liveRunner.UpdateGraph(syncData);
            AssertValue("z", 1);
        }
...
"
            ...
            // Modify 'a 'to false
            modified = new List<Subtree>();
            modified.Add(TestFrameWork.CreateSubTreeFromCode(guid1, codes[0]));
            syncData = new GraphSyncData(null, null, modified);
            liveRunner.UpdateGraph(syncData);
...
"
            ...
            // Reconnect input
            modified = new List<Subtree>();
            subtree = TestFrameWork.CreateSubTreeFromCode(guid1, codes[2]);
            modified.Add(subtree);
            syncData = new GraphSyncData(null, null, modified);
            liveRunner.UpdateGraph(syncData);
            AssertValue("j", 100);
...
"
            ...
            // Disconnect input
            List<Subtree> modified = new List<Subtree>();
            Subtree subtree = TestFrameWork.CreateSubTreeFromCode(guid3, codes[3]);
            modified.Add(subtree);
            syncData = new GraphSyncData(null, null, modified);
            liveRunner.UpdateGraph(syncData);
            ...
            // Reconnect input
            modified = new List<Subtree>();
            subtree = TestFrameWork.CreateSubTreeFromCode(guid3, codes[4]);
            modified.Add(subtree);
            syncData = new GraphSyncData(null, null, modified);
            liveRunner.UpdateGraph(syncData);
            AssertValue("j", 1);
...
"
            ...
            // Run 2
            List<Subtree> modified = new List<Subtree>();
            modified.Add(TestFrameWork.CreateSubTreeFromCode(guid5, codes[5]));
            syncData = new GraphSyncData(null, null, modified);
            liveRunner.UpdateGraph(syncData);
            ...
            modified.Add(TestFrameWork.CreateSubTreeFromCode(guid5, codes[7]));
            syncData = new GraphSyncData(null, null, modified);
            liveRunner.UpdateGraph(syncData);
            ...
            // Run 4
            modified = new List<Subtree>();
            modified.Add(TestFrameWork.CreateSubTreeFromCode(guid3, codes[8]));
            syncData = new GraphSyncData(null, null, modified);
            liveRunner.UpdateGraph(syncData);
